...
class basicdb extends \PDO
{
    ...
    public function __construct($host, $dbname, $username, $password, $charset = 'utf8',$prefix = '')
    {
        try {
    ...
    {
        $this->sql = 'SELECT * FROM ' . $this->prefix.$tableName;
    ...
    public function join($targetTable, $joinSql, $joinType = 'inner')
    {
        ...
        $targetTable = $this->prefix.$targetTable;
    ...
    {
        $this->sql = 'INSERT INTO ' . $this->prefix.$tableName;
        return $this;
    }
    ...
    {
        $this->sql = 'UPDATE ' . $this->prefix.$tableName;
        return $this;
    }

    public function delete($tableName)
    {
        $this->sql = 'DELETE FROM ' . $this->prefix.$tableName;
        return $this;
    }
    ...
    {
        return $this->query('TRUNCATE TABLE ' . $this->dbName . '.' .$this->prefix. $tableName);
    }
